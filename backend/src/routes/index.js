...
router.get('/prescriptions', auth, roleGuard(['doctor', 'nurse', 'info_desk', 'patient', 'admin', 'pharmacy']), prescriptionController.getAll);
router.get('/prescriptions/:id', auth, roleGuard(['doctor', 'nurse', 'info_desk', 'patient', 'admin', 'pharmacy']), idParam, prescriptionController.getById);
...
router.get('/schedules/patient/:patientId', auth, roleGuard(['doctor', 'nurse', 'patient', 'admin', 'info_desk']), patientIdParam, scheduleController.getByPatient);
router.get('/schedules/:id', auth, roleGuard(['doctor', 'nurse', 'admin', 'info_desk']), idParam, scheduleController.getById);
