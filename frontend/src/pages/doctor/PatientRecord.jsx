    ...
    <div className="patient-record-container">
      ...
      <div className="pr-header">
        <div className="pr-header-left">
          <button className="pr-back-icon" onClick={() => navigate('/doctor/patients')} title="Back to My Patients">
            <ArrowLeft size={20} />
          </button>
          <div>
        ...
        <div className="pr-header-right" style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
        ...
        {consultations.map(c => (
          <div key={c.id} className="pr-history-card">
            ...
            <div className="pr-card-body">
              ...
              <p><strong>Diagnosis:</strong> {c.assessment || c.diagnosis || '—'}</p>
            </div>
          </div>
        ))}
      </div>
