...
Admission.init(
  {
    ...
    reason_for_admission: { type: DataTypes.TEXT, allowNull: true },
    treatment_plan: { type: DataTypes.TEXT, allowNull: true },
    progress_notes: { type: DataTypes.TEXT, allowNull: true },
    nurse_notes: { type: DataTypes.TEXT, allowNull: true },
    final_diagnosis: { type: DataTypes.TEXT, allowNull: true },
    condition_at_discharge: { type: DataTypes.STRING(255), allowNull: true },
    discharge_summary: { type: DataTypes.TEXT, allowNull: true },
    discharge_assessment: { type: DataTypes.TEXT, allowNull: true },
    follow_up_date: { type: DataTypes.DATE, allowNull: true },
    follow_up_instructions: { type: DataTypes.TEXT, allowNull: true },
  },
  {
    sequelize,
    modelName: 'Admission',
